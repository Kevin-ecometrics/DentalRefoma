...
const Services: React.FC = () => {
  ...
  const handlePrevTreatment = () => {
    setDirection("left");
    const currentIndex = currentTreatments.findIndex(
      (t) => t.id === selectedTreatment.id
    );
    const prevIndex =
      (currentIndex - 1 + currentTreatments.length) % currentTreatments.length;
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-2/3 bg-white rounded-lg shadow-md p-6">
              ...
              <button
                ...
                className="block mx-auto bg-[#aed136] text-white px-6 py-3 rounded-full font-semibold shadow-md hover:bg-[#4f646f] transition-all cursor-pointer"
              >
                {buttonText}
              </button>
            </div>
            ...
            <div className="w-full bg-white rounded-lg shadow-md p-6 mb-4">
              <AnimatePresence mode="wait" custom={direction}>
                ...
                >
                  ...
                  <button
                    onClick={scrollToReserva}
                    className="mx-auto bg-[#aed136] text-white px-4 py-2 rounded-full font-semibold shadow-md hover:bg-[#4f646f] transition-all flex items-center justify-center gap-2 text-sm cursor-pointer"
                  >
